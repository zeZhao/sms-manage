...
},
{
    ...
    {
        path: '/sysBelielConfig/index',
        component: () =>
            import('@/views/ConfigManagement/sysBelielConfig/index'),
        name: 'sysBelielConfig',
        meta: {
            keepAlive: false,
            title: '优化比例配置'
        }
...
},
{
    ...
    {
        path: '/sysExportBill/index',
        component: () =>
            import('@/views/FinanceManagement/sysExportBill/index'),
        name: 'sysExportBill',
        meta: {
            keepAlive: false,
            title: '导出账单'
