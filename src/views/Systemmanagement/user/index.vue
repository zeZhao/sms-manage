    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true">
                ...
                <el-form-item>
                    <el-select v-model="roleType" placeholder="类型" clearable>
        ...
        <el-dialog title="新增运营账号" :visible.sync="customerAddInfo" :close-on-click-modal="false" style="margin: 0 auto">
        ...
        <el-dialog title="运营账号修改" :visible.sync="customerInfo" :close-on-click-modal="false" style="margin: 0 auto">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      delUser(row){
        this.$confirm("删除运营账号后，运营人员将无法登陆", "您确定要删除运营账号吗? ", {
