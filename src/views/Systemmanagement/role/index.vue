<template>
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true">
                <el-form-item>
                    <el-input v-model="roleIdSearch" clearable placeholder="角色ID" />
                </el-form-item>
                <el-form-item>
                ...
                <el-form-item style="float: right">
                    <el-button type="primary"   @click="customerAddInfo = true;getNavList()">新增角色</el-button>
                </el-form-item>
            </el-form>
        </el-col>
        <el-table
        ...
        <el-dialog title="新增角色" :visible.sync="customerAddInfo" :close-on-click-modal="false" style="margin: 0 auto">
            <el-form  ref="addForm" label-width="100px" :model="addInfo" :rules="updateFormRules" class="demo-ruleForm">
                ...
                <el-form-item label="角色类型">
                    <el-select style="width: 100%" @change="getNavList" v-model="addInfo.roleType" placeholder="角色类型" clearable>
                        <el-option value="1" label="前端角色" />
                        <el-option value="2" label="后端角色" />
                    </el-select>
                </el-form-item>
        ...
        <el-dialog title="角色修改" :visible.sync="customerInfo" :close-on-click-modal="false" style="margin: 0 auto">
        ...
        <el-dialog title="绑定权限" :visible.sync="setRoleMenu" :close-on-click-modal="false" style="margin: 0 auto">
            <el-form  ref="updateCustomForm" label-width="120px" :model="setInfo" :rules="updateFormRules" class="demo-ruleForm">
                <el-form-item label="菜单">
                    <el-tree
                            ref="tree"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      delUser(row){
        this.$confirm("删除角色后，拥有该角色的管理员将不能系统访问，请谨慎操作", "您确定要删除角色吗? ", {
      ...
      setNavuserList(id,type){
        ...
        if (type==1){
          var params = {
            roleId: id,
            menuIds:this.$refs.add.getCheckedKeys()
          };
        }  else {
          var params = {
            roleId: this.roleId,
