    ...
    <div>
        ...
        <el-table
            ...
            <el-table-column
                    ...
                    width="150">
                <template slot-scope="scope">
                    <el-button v-if="scope.row.parentId == 0"  @click="AddShow(scope.row)" type="text" size="small">新增</el-button>
        ...
        <el-dialog title="新增目录" :visible.sync="customerAddInfo" :close-on-click-modal="false" style="margin: 0 auto">
        ...
        <el-dialog title="新增菜单" :visible.sync="addNavList" :close-on-click-modal="false" style="margin: 0 auto">
            <el-form  ref="addForm" label-width="120px" :model="addInfo" class="demo-ruleForm">
                <el-form-item label="目录名称">
        ...
        <el-dialog :title="setTitle" :visible.sync="customerInfo" :close-on-click-modal="false" style="margin: 0 auto">
...
<script>
  export default {
    ...
    methods: {
      ...
      deleteCustomer(row) {
        this.$confirm(row.parentId ==0?'删除后子级菜单也将被删除，请谨慎操作':'删除后子级菜单将不存在，请谨慎操作', row.parentId ==0?'您确定要删除父级目录吗？':'您确定要删除子级菜单吗？', {
