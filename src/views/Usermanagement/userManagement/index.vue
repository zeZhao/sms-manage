<template>
  <section>
    ...
    <el-table max-height="500" :data="dataList" highlight-current-row style="width: 100%;">
      ...
      >
        ...
        <el-form-item label="可扩展的位数" prop="sublong">
          <el-input
            ...
            clearable
            placeholder="请输入可扩展的位数"
          />
        </el-form-item>
        <el-form-item label="计费类型" prop="reductType">
          <el-select
            style="width: 100%"
            v-model="addInfo.reductType"
            placeholder="请选择计费类型"
        ...
        <el-form-item label="状态报告类型" prop="reportType">
          <el-select
            style="width: 100%"
            v-model="addInfo.reportType"
            placeholder="请选择状态报告类型"
            popper-class="select-option"
          >
